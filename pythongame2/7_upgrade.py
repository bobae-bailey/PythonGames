...
# Play button
play_btn = pygame.image.load(os.path.join(image_path, 'play_btn.png'))
play_btn_width = play_btn.get_rect().width
play_btn_height = play_btn.get_rect().height
play_btn_x_pos = (screen_width / 2) - (play_btn_width / 2)
play_btn_y_pos = (screen_height / 2) - (play_btn_height / 2)
...
while running:
    ...
    screen.blit(play_btn, (play_btn_x_pos, play_btn_y_pos))
